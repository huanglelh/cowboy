...
function init() {
    ...
    pop("#cid", "verto_demo_cid", "1000");
    pop("#textto", "verto_demo_textto", "1000");

    pop("#login", "verto_demo_login", "1000");
    pop("#passwd", "verto_demo_passwd", "1234");

    pop("#hostName", "verto_demo_hostname", "10.28.163.115");
    pop("#wsURL", "verto_demo_wsurl", "wss://" + "10.28.16.115" + ":8082");
